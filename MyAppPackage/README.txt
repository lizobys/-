Моя Программа: ElementFinder
Описание:
Это консольное приложение, разработанное на C++. Программа ищет элементы в массиве.
...
2. Запустите файл "prakt6.exe" двойным кликом мыши.
...
Разработчик: Васильева Елизавета
